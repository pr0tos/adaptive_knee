...
def main():
    ...
    config = load_config('dynamic/config.yaml')
    
    # Загрузка данных
    time_data, q1_data = DataLoader.load_data('dynamic/data/motion.csv')
    ...
    # Сохранение данных q2 и времени
    np.save('dynamic/data/q2_data.npy', q2)
    np.save('dynamic/data/t_data.npy', t)
